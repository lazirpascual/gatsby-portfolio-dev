...
export const projectsData = [
  {
    ...
    info: `Fullstack MERN application that models a social media website, including a Realtime Chat feature using Socket.IO. Users can register/login (JSON Web Token), create and update their own profile, chat with another user, follow/unfollow a user, and search for a user's profile or post. Posts can also be created, deleted, and updated, where each user can like/dislike a post and add/delete comments to each post.`,
    info2:
  ...
  },
  {
    id: nanoid(),
    img: 'project.jpg',
    subtitle: 'React, Node.js, Express, PostgreSQL',
    ...
    info2:
      'Frontend uses React.js (Context API) and Material-UI to develop a responsive design. Backend is built with Node.js, Express API and PostgreSQL. Includes Unit and Integration Testing.',
  ...
  },
  {
    ...
    img: 'project2.jpg',
    title: 'CV Builder',
    subtitle: 'React, React-PDF, Material-UI',
    ...
    url: 'https://lazirpascual.github.io/cv-builder/',
    repo: 'https://github.com/lazirpascual/cv-builder', // if no repo, the button will not show up
  },
];
